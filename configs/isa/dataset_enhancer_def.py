...
column_defs = [
    ...
    em.Column.define('enhancer', em.builtin_types['text'],
        nullok=False,
    ),
]
...
key_defs = [
    ...
    em.Key.define(['RID'],
                   constraint_names=[('isa', 'dataset_enhancer_RID_key')],
    ),
]
...
{'dataset_tags_edit_guard': {'projection': [{'outbound': ['isa',
                                                          'dataset_enhancer_dataset_id_fkey']},
                                            {'outbound': ['isa',
...
table_def = em.Table.define('dataset_enhancer',

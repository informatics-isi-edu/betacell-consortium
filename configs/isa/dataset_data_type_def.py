...
key_defs = [
    em.Key.define(['dataset_id', 'data_type'],
                   constraint_names=[('isa', 'dataset_data_type_pkey')],
    ),
    em.Key.define(['RID'],
                   constraint_names=[('isa', 'dataset_data_type_RID_key')],
    ),
]
...
table_def = em.Table.define('dataset_data_type',

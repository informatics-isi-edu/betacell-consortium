...
column_defs = [
    ...
    em.Column.define('somite_count', em.builtin_types['text'],
        nullok=False,
    ),
]
...
key_defs = [
    ...
    em.Key.define(['RID'],
                   constraint_names=[('isa', 'dataset_somite_count_RID_key')],
    ),
]
...
fkey_defs = [
    em.ForeignKey.define(['dataset_id'],
            'isa', 'dataset', ['id'],
            constraint_names=[('isa', 'dataset_somite_count_dataset_id_fkey')],
        on_update='CASCADE',
        on_delete='CASCADE',
    ),
]
...
{'dataset_tags_edit_guard': {'projection': [{'outbound': ['isa',
                                                          'dataset_somite_count_dataset_id_fkey']},
                                            {'outbound': ['isa',
...
table_def = em.Table.define('dataset_somite_count',

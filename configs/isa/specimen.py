...
visible_columns = \
    {'compact': ['RID', ['isa', 'specimen_pkey'], 'local_identifier',
     ...
     'detailed': [['isa', 'specimen_pkey'], 'local_identifier',
                  ...
                  {'markdown_name': 'Cellular Location', 'source': [{'outbound': ['isa',
                                            'specimen_cellular_location_terms_fkey']},
                              'name']},
...
{'detailed': [['isa', 'specimen_compound_specimen_fkey'],
 ...
 'entry': [['isa', 'specimen_compound_specimen_fkey'],
           ['isa', 'xray_tomography_data_replicate_fkey'],
           ['isa', 'mesh_data_replicate_fkey'],
           ['isa', 'processed_data_replicate_fkey'],
           ['isa', 'imaging_data_replicate_fkey']]}

...
key_defs = [
    em.Key.define(['dataset_id', 'genotype'],
                   constraint_names=[('isa', 'dataset_genotype_pkey')],
    ),
    em.Key.define(['RID'],
                   constraint_names=[('isa', 'dataset_genotype_RID_key')],
    ),
]
...
fkey_defs = [
    em.ForeignKey.define(['genotype'],
            ...
            constraint_names=[('isa', 'dataset_genotype_genotype_fkey')],
    ...
    em.ForeignKey.define(['dataset_id'],
            'isa', 'dataset', ['id'],
            constraint_names=[('isa', 'dataset_genotype_dataset_id_fkey')],
...
{'dataset_tags_edit_guard': {'projection': [{'outbound': ['isa',
                                                          'dataset_genotype_dataset_id_fkey']},
                                            {'outbound': ['isa',
...
table_def = em.Table.define('dataset_genotype',

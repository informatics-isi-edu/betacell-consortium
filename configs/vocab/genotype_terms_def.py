...
key_defs = [
    em.Key.define(['dbxref'],
                   constraint_names=[('vocab', 'genotype_terms_pkey')],
    ),
    em.Key.define(['cv', 'name', 'is_obsolete'],
                   constraint_names=[('vocab', 'genotype_terms_cv_name_is_obsolete_key')],
    ),
    em.Key.define(['RID'],
                   constraint_names=[('vocab', 'genotype_terms_RID_key')],
    ),
]
...
fkey_defs = [
    em.ForeignKey.define(['cv'],
            ...
            constraint_names=[('vocab', 'genotype_terms_cv_fkey')],
    ),
    em.ForeignKey.define(['dbxref'],
            'data_commons', 'cvterm', ['dbxref'],
            constraint_names=[('vocab', 'genotype_terms_dbxref_fkey')],
    ),
]


visible_columns=\
{'*': ['name', 'dbxref', 'definition', ['vocab', 'genotype_terms_cv_fkey'],
       'is_obsolete', 'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'genotype_terms_dbxref_fkey']],
...
{'*': [{'source': [{'inbound': ['isa', 'dataset_genotype_genotype_fkey']},
                   {'outbound': ['isa', 'dataset_genotype_dataset_id_fkey']},
                   'id']}]}
...
table_def = em.Table.define('genotype_terms',

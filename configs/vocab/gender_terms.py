...
fkey_defs = [
    em.ForeignKey.define(['cv'],
            ...
            constraint_names=[('vocab', 'gender_terms_cv_fkey')],
    ),
    em.ForeignKey.define(['dbxref'],
            'data_commons', 'cvterm', ['dbxref'],
            constraint_names=[('vocab', 'gender_terms_dbxref_fkey')],
    ),
]


visible_columns = \
{'*': ['name', 'dbxref', 'definition', ['vocab', 'gender_terms_cv_fkey'],
       'is_obsolete', 'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'gender_terms_dbxref_fkey']],
...
table_def = em.Table.define('gender_terms',

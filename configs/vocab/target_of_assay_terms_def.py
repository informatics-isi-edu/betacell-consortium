...
table_name = 'target_of_assay_terms'
schema_name = 'vocab'
...
fkey_defs = [
    em.ForeignKey.define(['dbxref'],
            ...
            constraint_names=[('vocab', 'target_of_assay_terms_dbxref_fkey')],
    ),
    em.ForeignKey.define(['cv'],
            'data_commons', 'cv', ['name'],
            constraint_names=[('vocab', 'target_of_assay_terms_cv_fkey')],
    ),
]
...
{'*': ['name', 'dbxref', 'definition',
       ['vocab', 'target_of_assay_terms_cv_fkey'], 'is_obsolete',
       'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'target_of_assay_terms_dbxref_fkey']],
...
{'*': [{'source': [{'inbound': ['isa',
                                'dataset_target_of_assay_target_of_assay_fkey']},
                   {'outbound': ['isa',
...
table_def = em.Table.define('target_of_assay_terms',

...
table_name = 'chromatin_modifier_terms'
schema_name = 'vocab'
...
key_defs = [
    em.Key.define(['name', 'cv', 'is_obsolete'],
                   constraint_names=[('vocab', 'chromatin_modifier_terms_cv_name_is_obsolete_key')],
    ),
    em.Key.define(['dbxref'],
                   constraint_names=[('vocab', 'chromatin_modifier_terms_pkey')],
    ),
    em.Key.define(['RID'],
                   constraint_names=[('vocab', 'chromatin_modifier_terms_RID_key')],
    ),
]
...
fkey_defs = [
    em.ForeignKey.define(['dbxref'],
            ...
            constraint_names=[('vocab', 'chromatin_modifier_terms_dbxref_fkey')],
    ),
    em.ForeignKey.define(['cv'],
            'data_commons', 'cv', ['name'],
            constraint_names=[('vocab', 'chromatin_modifier_terms_cv_fkey')],
    ),
]
...
{'*': ['name', 'dbxref', 'definition',
       ['vocab', 'chromatin_modifier_terms_cv_fkey'], 'is_obsolete',
       'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'chromatin_modifier_terms_dbxref_fkey']],
...
{'*': [{'source': [{'inbound': ['isa',
                                'dataset_chromatin_modifier_chromatin_modifier_fkey']},
                   {'outbound': ['isa',
                                 'dataset_chromatin_modifier_dataset_id_fkey']},
                   'id']}]}
...
table_def = em.Table.define('chromatin_modifier_terms',

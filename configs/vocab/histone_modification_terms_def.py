...
table_name = 'histone_modification_terms'
schema_name = 'vocab'
...
key_defs = [
    em.Key.define(['RID'],
                   constraint_names=[('vocab', 'histone_modification_terms_RID_key')],
    ),
    em.Key.define(['is_obsolete', 'cv', 'name'],
                   constraint_names=[('vocab', 'histone_modification_terms_cv_name_is_obsolete_key')],
    ),
    em.Key.define(['dbxref'],
                   constraint_names=[('vocab', 'histone_modification_terms_pkey')],
    ),
]
...
fkey_defs = [
    em.ForeignKey.define(['cv'],
            ...
            constraint_names=[('vocab', 'histone_modification_terms_cv_fkey')],
    ),
    em.ForeignKey.define(['dbxref'],
            'data_commons', 'cvterm', ['dbxref'],
            constraint_names=[('vocab', 'histone_modification_terms_dbxref_fkey')],
    ),
]
...
{'*': ['name', 'dbxref', 'definition',
       ['vocab', 'histone_modification_terms_cv_fkey'], 'is_obsolete',
       'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'histone_modification_terms_dbxref_fkey']],
...
{'*': [{'source': [{'inbound': ['isa',
                                'dataset_histone_modification_histone_modification_fkey']},
                   {'outbound': ['isa',
                                 'dataset_histone_modification_dataset_id_fkey']},
                   'id']}]}
...
table_def = em.Table.define('histone_modification_terms',

...
key_defs = [
    em.Key.define(['cv', 'name', 'is_obsolete'],
                   constraint_names=[('vocab', 'output_type_terms_cv_name_is_obsolete_key')],
    ),
    em.Key.define(['RID'],
                   constraint_names=[('vocab', 'output_type_terms_RID_key')],
    ),
    em.Key.define(['dbxref'],
                   constraint_names=[('vocab', 'output_type_terms_pkey')],
    ),
]
...
fkey_defs = [
    em.ForeignKey.define(['cv'],
            ...
            constraint_names=[('vocab', 'output_type_terms_cv_fkey')],
    ),
    em.ForeignKey.define(['dbxref'],
            'data_commons', 'cvterm', ['dbxref'],
            constraint_names=[('vocab', 'output_type_terms_dbxref_fkey')],
    ),
]


visible_columns=\
{'*': ['name', 'dbxref', 'definition', ['vocab', 'output_type_terms_cv_fkey'],
       'is_obsolete', 'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'output_type_terms_dbxref_fkey']],
...
{'*': [{'source': [{'inbound': ['isa', 'dataset_output_type_output_type_fkey']},
                   {'outbound': ['isa', 'dataset_output_type_dataset_id_fkey']},
                   'id']}]}
...
table_def = em.Table.define('output_type_terms',

...
visible_columns=\
{'*': ['name', 'dbxref', 'definition', ['vocab', 'phenotype_terms_cv_fkey'],
       'is_obsolete', 'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'phenotype_terms_dbxref_fkey']],
...
{'*': [{'source': [{'inbound': ['isa', 'dataset_phenotype_phenotype_fkey']},
                   {'outbound': ['isa', 'dataset_phenotype_dataset_fkey']},
                   'id']}]}
...
table_def = em.Table.define('phenotype_terms',

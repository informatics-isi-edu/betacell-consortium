...
column_defs = [em.Column.define('RID', em.builtin_types['ermrest_rid'], nullok=False,),
               ...
               em.Column.define('id', em.builtin_types['ermrest_curie'], nullok=False, comment=column_comment['id'],),
               em.Column.define('uri', em.builtin_types['ermrest_uri'], nullok=False, comment=column_comment['uri'],),

...
column_defs = [em.Column.define('RID', em.builtin_types['ermrest_rid'], nullok=False,),
               ...
               em.Column.define('id', em.builtin_types['ermrest_curie'], nullok=False, default=PBCCONSORTIUM:{RID}comment=column_comment['id'],),
               em.Column.define('uri', em.builtin_types['ermrest_uri'], nullok=False, default=/id/{RID}comment=column_comment['uri'],),
               em.Column.define('name', em.builtin_types['text'], nullok=False, comment=column_comment['name'],),
               em.Column.define('description', em.builtin_types['markdown'], nullok=False, comment=column_comment['description'],),
...
table_comment = 'Table of terms from UNIPROT identifying cellular location'
...
key_defs = [
    em.Key.define(['id'],
                  constraint_names=[
                      ('vocab', 'cellular_location_terms_idkey1')],
                  ),
    em.Key.define(['uri'],
                  constraint_names=[
                      ('vocab', 'cellular_location_terms_urikey1')],
                  ),
    em.Key.define(['RID'],
                  constraint_names=[
                      ('vocab', 'cellular_location_terms_RIDkey1')],
                  ),
]

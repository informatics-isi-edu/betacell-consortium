...
table_name = 'mouse_genetic_background_terms'
schema_name = 'vocab'
...
key_defs = [
    em.Key.define(['dbxref'],
                   constraint_names=[('vocab', 'mouse_genetic_background_terms_pkey')],
    ),
    em.Key.define(['is_obsolete', 'cv', 'name'],
                   constraint_names=[('vocab', 'mouse_genetic_background_terms_cv_name_is_obsolete_key')],
    ),
    em.Key.define(['RID'],
                   constraint_names=[('vocab', 'mouse_genetic_background_terms_RID_key')],
    ),
]
...
fkey_defs = [
    em.ForeignKey.define(['cv'],
            ...
            constraint_names=[('vocab', 'mouse_genetic_background_terms_cv_fkey')],
    ),
    em.ForeignKey.define(['dbxref'],
            'data_commons', 'cvterm', ['dbxref'],
            constraint_names=[('vocab', 'mouse_genetic_background_terms_dbxref_fkey')],
    ),
]
...
{'*': ['name', 'dbxref', 'definition',
       ['vocab', 'mouse_genetic_background_terms_cv_fkey'], 'is_obsolete',
       'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'mouse_genetic_background_terms_dbxref_fkey']],
...
{'*': [{'source': [{'inbound': ['isa',
                                'dataset_mouse_genetic_background_mouse_genetic_background_fkey']},
                   {'outbound': ['isa',
                                 'dataset_mouse_genetic_background_dataset_id_fkey']},
                   'id']}]}
...
table_def = em.Table.define('mouse_genetic_background_terms',

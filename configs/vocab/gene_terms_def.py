...
visible_columns = \
{'*': ['name', 'dbxref', 'definition', ['vocab', 'gene_terms_cv_fkey'],
       'is_obsolete', 'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'gene_terms_dbxref_fkey']],
...
{'*': [{'source': [{'inbound': ['isa', 'dataset_gene_gene_fkey']},
                   {'outbound': ['isa', 'dataset_gene_dataset_id_fkey']},
                   'id']}]}
...
table_def = em.Table.define('gene_terms',

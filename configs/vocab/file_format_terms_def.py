...
key_defs = [
    em.Key.define(['dbxref'],
                   constraint_names=[('vocab', 'file_format_terms_pkey')],
    ),
    em.Key.define(['cv', 'name', 'is_obsolete'],
                   constraint_names=[('vocab', 'file_format_terms_cv_name_is_obsolete_key')],
    ),
    em.Key.define(['RID'],
                   constraint_names=[('vocab', 'file_format_terms_RID_key')],
    ),
]
...
fkey_defs = [
    em.ForeignKey.define(['cv'],
            ...
            constraint_names=[('vocab', 'file_format_terms_cv_fkey')],
    ),
    em.ForeignKey.define(['dbxref'],
            'data_commons', 'cvterm', ['dbxref'],
            constraint_names=[('vocab', 'file_format_terms_dbxref_fkey')],
    ),
]


visible_columns=\
{'*': ['name', 'dbxref', 'definition', ['vocab', 'file_format_terms_cv_fkey'],
       'is_obsolete', 'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'file_format_terms_dbxref_fkey']],
...
{'*': [{'source': [{'inbound': ['isa', 'dataset_file_format_file_format_fkey']},
                   {'outbound': ['isa', 'dataset_file_format_dataset_id_fkey']},
                   'id']}]}

...
fkey_defs = [
    em.ForeignKey.define(['dbxref'],
            ...
            constraint_names=[('vocab', 'human_age_terms_dbxref_fkey')],
    ),
    em.ForeignKey.define(['cv'],
            'data_commons', 'cv', ['name'],
            constraint_names=[('vocab', 'human_age_terms_cv_fkey')],
    ),
]


visible_columns=\
{'*': ['name', 'dbxref', 'definition', ['vocab', 'human_age_terms_cv_fkey'],
       'is_obsolete', 'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'human_age_terms_dbxref_fkey']],
...
table_def = em.Table.define('human_age_terms',

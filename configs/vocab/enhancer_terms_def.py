...
visible_columns = \
{'*': ['name', 'dbxref', 'definition', ['vocab', 'enhancer_terms_cv_fkey'],
       'is_obsolete', 'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'enhancer_terms_dbxref_fkey']],
...
table_def = em.Table.define('enhancer_terms',

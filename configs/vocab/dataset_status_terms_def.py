...
table_name = 'dataset_status_terms'
schema_name = 'vocab'
...
key_defs = [
    em.Key.define(['cv', 'name', 'is_obsolete'],
                   constraint_names=[('vocab', 'dataset_status_terms_cv_name_is_obsolete_key')],
    ),
    em.Key.define(['dbxref'],
                   constraint_names=[('vocab', 'dataset_status_terms_pkey')],
    ),
    em.Key.define(['RID'],
                   constraint_names=[('vocab', 'dataset_status_terms_RID_key')],
    ),
]
...
fkey_defs = [
    em.ForeignKey.define(['dbxref'],
            ...
            constraint_names=[('vocab', 'dataset_status_terms_dbxref_fkey')],
    ),
    em.ForeignKey.define(['cv'],
            'data_commons', 'cv', ['name'],
            constraint_names=[('vocab', 'dataset_status_terms_cv_fkey')],
    ),
]
...
{'*': ['name', 'dbxref', 'definition',
       ['vocab', 'dataset_status_terms_cv_fkey'], 'is_obsolete',
       'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'dataset_status_terms_dbxref_fkey']],
...
{'*': [{'source': [{'inbound': ['isa',
                                'dataset_dataset_status_dataset_status_fkey']},
                   {'outbound': ['isa',
                                 'dataset_dataset_status_dataset_id_fkey']},
                   'id']}]}
...
table_def = em.Table.define('dataset_status_terms',

...
key_defs = [
    em.Key.define(['cv', 'is_obsolete', 'name'],
                   constraint_names=[('vocab', 'mutation_terms_cv_name_is_obsolete_key')],
    ),
    em.Key.define(['dbxref'],
                   constraint_names=[('vocab', 'mutation_terms_pkey')],
    ),
    em.Key.define(['RID'],
                   constraint_names=[('vocab', 'mutation_terms_RID_key')],
    ),
]
...
fkey_defs = [
    em.ForeignKey.define(['dbxref'],
            ...
            constraint_names=[('vocab', 'mutation_terms_dbxref_fkey')],
    ),
    em.ForeignKey.define(['cv'],
            'data_commons', 'cv', ['name'],
            constraint_names=[('vocab', 'mutation_terms_cv_fkey')],
    ),
]


visible_columns=\
{'*': ['name', 'dbxref', 'definition', ['vocab', 'mutation_terms_cv_fkey'],
       'is_obsolete', 'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'mutation_terms_dbxref_fkey']],
...
{'*': [{'source': [{'inbound': ['isa', 'dataset_mutation_mutation_fkey']},
                   {'outbound': ['isa', 'dataset_mutation_dataset_id_fkey']},
                   'id']}]}
...
table_def = em.Table.define('mutation_terms',

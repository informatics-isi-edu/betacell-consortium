...
table_name = 'rnaseq_selection_terms'
schema_name = 'vocab'
...
key_defs = [
    em.Key.define(['cv', 'name', 'is_obsolete'],
                   constraint_names=[('vocab', 'rnaseq_selection_terms_cv_name_is_obsolete_key')],
    ),
    em.Key.define(['RID'],
                   constraint_names=[('vocab', 'rnaseq_selection_terms_RID_key')],
    ),
    em.Key.define(['dbxref'],
                   constraint_names=[('vocab', 'rnaseq_selection_terms_pkey')],
    ),
]
...
fkey_defs = [
    em.ForeignKey.define(['cv'],
            ...
            constraint_names=[('vocab', 'rnaseq_selection_terms_cv_fkey')],
    ),
    em.ForeignKey.define(['dbxref'],
            'data_commons', 'cvterm', ['dbxref'],
            constraint_names=[('vocab', 'rnaseq_selection_terms_dbxref_fkey')],
    ),
]
...
{'*': ['name', 'dbxref', 'definition',
       ['vocab', 'rnaseq_selection_terms_cv_fkey'], 'is_obsolete',
       'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'rnaseq_selection_terms_dbxref_fkey']],
...
{'*': [{'source': [{'inbound': ['isa',
                                'dataset_rnaseq_selection_rnaseq_selection_fkey']},
                   {'outbound': ['isa',
                                 'dataset_rnaseq_selection_dataset_id_fkey']},
                   'id']}]}
...
table_def = em.Table.define('rnaseq_selection_terms',

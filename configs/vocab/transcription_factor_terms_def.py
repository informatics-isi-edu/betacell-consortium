...
table_name = 'transcription_factor_terms'
schema_name = 'vocab'
...
key_defs = [
    em.Key.define(['dbxref'],
                   constraint_names=[('vocab', 'transcription_factor_terms_pkey')],
    ),
    em.Key.define(['is_obsolete', 'cv', 'name'],
                   constraint_names=[('vocab', 'transcription_factor_terms_cv_name_is_obsolete_key')],
    ),
    em.Key.define(['RID'],
                   constraint_names=[('vocab', 'transcription_factor_terms_RID_key')],
    ),
]
...
fkey_defs = [
    em.ForeignKey.define(['dbxref'],
            ...
            constraint_names=[('vocab', 'transcription_factor_terms_dbxref_fkey')],
    ),
    em.ForeignKey.define(['cv'],
            'data_commons', 'cv', ['name'],
            constraint_names=[('vocab', 'transcription_factor_terms_cv_fkey')],
    ),
]
...
{'*': ['name', 'dbxref', 'definition',
       ['vocab', 'transcription_factor_terms_cv_fkey'], 'is_obsolete',
       'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'transcription_factor_terms_dbxref_fkey']],
...
{'*': [{'source': [{'inbound': ['isa',
                                'dataset_transcription_factor_transcription_factor_fkey']},
                   {'outbound': ['isa',
                                 'dataset_transcription_factor_dataset_id_fkey']},
                   'id']}]}
...
table_def = em.Table.define('transcription_factor_terms',

...
table_name = 'paired_end_or_single_read_terms'
schema_name = 'vocab'
...
key_defs = [
    em.Key.define(['cv', 'is_obsolete', 'name'],
                   constraint_names=[('vocab', 'paired_end_or_single_read_terms_cv_name_is_obsolete_key')],
    ),
    em.Key.define(['RID'],
                   constraint_names=[('vocab', 'paired_end_or_single_read_terms_RID_key')],
    ),
    em.Key.define(['dbxref'],
                   constraint_names=[('vocab', 'paired_end_or_single_read_terms_pkey')],
    ),
]
...
fkey_defs = [
    em.ForeignKey.define(['cv'],
            ...
            constraint_names=[('vocab', 'paired_end_or_single_read_terms_cv_fkey')],
    ),
    em.ForeignKey.define(['dbxref'],
            'data_commons', 'cvterm', ['dbxref'],
            constraint_names=[('vocab', 'paired_end_or_single_read_terms_dbxref_fkey')],
    ),
]
...
{'*': ['name', 'dbxref', 'definition',
       ['vocab', 'paired_end_or_single_read_terms_cv_fkey'], 'is_obsolete',
       'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'paired_end_or_single_read_terms_dbxref_fkey']],
...
{'*': [{'source': [{'inbound': ['isa',
                                'dataset_paired_end_or_single_read_paired_end_or_single_read_fkey']},
                   {'outbound': ['isa',
                                 'dataset_paired_end_or_single_read_dataset_id_fkey']},
                   'id']}]}
...
table_def = em.Table.define('paired_end_or_single_read_terms',

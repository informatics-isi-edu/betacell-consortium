...
column_defs = [
    ...
    em.Column.define('sort_key', em.builtin_types['int4'],
    ),
]
...
visible_columns=\
{'*': ['name', 'dbxref', 'definition', ['vocab', 'stage_terms_cv_fkey'],
       'is_obsolete', 'is_relationshiptype', 'synonyms', 'alternate_dbxrefs'],
 'entry': [['vocab', 'stage_terms_dbxref_fkey']],
...
{'*': [{'source': [{'inbound': ['isa', 'dataset_stage_stage_fkey']},
...
table_def = em.Table.define('stage_terms',

...
table_name = 'mapping_assembly_terms'
schema_name = 'vocab'
...
key_defs = [
    em.Key.define(['dbxref'],
                   constraint_names=[('vocab', 'mapping_assembly_terms_pkey')],
    ),
    em.Key.define(['is_obsolete', 'cv', 'name'],
                   constraint_names=[('vocab', 'mapping_assembly_terms_cv_name_is_obsolete_key')],
    ),
    em.Key.define(['RID'],
                   constraint_names=[('vocab', 'mapping_assembly_terms_RID_key')],
    ),
]
...
{'*': ['name', 'dbxref', 'definition',
 ...
 'entry': [['vocab', 'mapping_assembly_terms_dbxref_fkey']],
...
table_def = em.Table.define('mapping_assembly_terms',

...
column_annotations = {
    ...
    'url': {
        tags.asset: {
            ...
            'byte_count',
            'url_pattern':
            '/hatrac/commons/data/{{{_dataset}}}/{{{_replicate}}}/{{{filename}}}',
            'md5':
            'md5'
        }
    },
    ...
    'file_type': {
        tags.column_display: {
            'compact': {
                'markdown_pattern':
                '{{{$fkeys.isa.imaging_data_file_type_fkey.rowName}}}'
            }
        }
    },
    'submitted_on': {
...
visible_columns = {
    ...
    'detailed': [['isa', 'imaging_data_pkey'],
                 ...
                 'submitted_on'],
    'compact': [['isa', 'imaging_data_pkey'], 'replicate_fkey', 'url',
                'file_type', 'byte_count', 'md5', 'submitted_on']
}

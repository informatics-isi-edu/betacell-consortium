...
table_acl_bindings = {
    'project_suppl_edit_guard': {
        ...
        'projection': [
            {
                'outbound': ['isa', 'project_investigator_project_id_fkey']
            }, {
...
key_defs = [
    em.Key.define(
        ['person', 'project_id'], constraint_names=[('isa', 'project_investigator_pkey')],
    ),
    em.Key.define(['RID'], constraint_names=[('isa', 'project_investigator_RID_key')],
                  ),
]

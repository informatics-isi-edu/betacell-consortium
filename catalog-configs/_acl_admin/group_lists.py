...
column_comment = {
    'name':
    'Name of grouplist, used in foreign keys. This table is maintained by the rbk_acls program and should not be updated by hand.',
    'groups':
    'List of groups. This table is maintained by the rbk_acls program and should not be updated by hand.',
    'RMT':
...
table_annotations = {
    'tag:isrd.isi.edu,2016:generated': generated,
}

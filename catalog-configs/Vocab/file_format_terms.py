...
key_defs = [
    em.Key.define(['uri'], constraint_names=[('vocab', 'file_format_terms_urikey1')],
                  ),
    em.Key.define(['id'], constraint_names=[('vocab', 'file_format_terms_idkey1')],
                  ),
    em.Key.define(['RID'], constraint_names=[('vocab', 'file_format_terms_RIDkey1')],
                  ),
]

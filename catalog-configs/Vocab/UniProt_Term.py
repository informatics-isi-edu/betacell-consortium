...
table_comment = 'Table of UniProt terms'
...
key_defs = [
    em.Key.define(['uri'], constraint_names=[('Vocab', 'UniProt_Term_urikey1')],
                  ),
    em.Key.define(['id'], constraint_names=[('Vocab', 'UniProt_Term_idkey1')],
                  ),
    em.Key.define(['RID'], constraint_names=[('Vocab', 'UniProt_Term_RIDkey1')],
                  ),
]

...
key_defs = [
    em.Key.define(['id'], constraint_names=[('vocab', 'file_type_terms_idkey1')],
                  ),
    em.Key.define(['RID'], constraint_names=[('vocab', 'file_type_terms_RIDkey1')],
                  ),
    em.Key.define(['uri'], constraint_names=[('vocab', 'file_type_terms_urikey1')],
                  ),
]

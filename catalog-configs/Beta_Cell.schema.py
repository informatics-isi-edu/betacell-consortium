...
table_names = [
    'Processed_Tomography_Data', 'Protocol', 'File', 'Collection_Biosample',
    'PHYRE2_Model', 'PDB_Model', 'Dataset', 'Experiment', 'XRay_Tomography_Data',
    'Biosample', 'Protocol_Step_Additive_Term', 'Cell_Line', 'Protocol_Step',
    'Mass_Spec_Data', 'Specimen', 'Protocol_Type', 'Ingredient',
]
...
schema_def = em.Schema.define(
    'Beta_Cell', comment=comment, acls=acls, annotations=annotations,
)

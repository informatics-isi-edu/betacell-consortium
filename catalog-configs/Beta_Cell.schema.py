...
table_names = [
    'Collection_Biosample', 'Dataset', 'Biosample', 'Cell_Line', 'Experiment', 'File', 'Ingredient',
    'Mass_Spec_Data', 'PHYRE2_Model', 'Processed_Tomography_Data', 'Protocol', 'Protocol_Step',
    'Protocol_Step_Additive_Term', 'Protocol_Type', 'XRay_Tomography_Data', 'Specimen', 'PDB_Model',
]

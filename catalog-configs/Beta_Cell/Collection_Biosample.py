...
column_annotations = {
    'RCB': {
        ...
        tags.column_display: {
            '*': {
                'markdown_pattern':
                '{{{$fkeys.Beta_Cell.Collection_Biosample_RCB_Fkey.values._display_name}}}'
            }
        }
    },
    'Collection': {},
...
visible_columns = {
    '*': [
        'RID', 'RCB', ['Common', 'Collection_Biosample_Collection_fkey'],
...
key_defs = [
    em.Key.define(
        ...
        constraint_names=[('Beta_Cell',
                           'Collection_Biosample_Collection_Biosample_key')],
...
fkey_defs = [
    em.ForeignKey.define(
        ...
        'ermrest_client',
        ['id'],
        constraint_names=[('Beta_Cell', 'Collection_Biosample_RCB_Fkey')],
        acls={
            'insert': ['*'],
            'update': ['*']
        },

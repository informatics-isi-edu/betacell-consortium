...
column_annotations = {
    'RCB': {
        ...
        tags.column_display: {
            '*': {
                'markdown_pattern':
                '{{{$fkeys.Beta_Cell.XRay_Tomography_Data_RCB_Fkey.values._display_name}}}'
            }
        }
    },
    'Dataset': {},
    ...
    'File_Type': {
        tags.column_display: {
            'compact': {
                'markdown_pattern':
                '{{{$fkeys.Beta_Cell.XRay_Tomography_Data_File_Type_FKey.rowName}}}'
            }
        }
    },
    'Submitted_On': {},
...
visible_columns = {
    'filter': {
        ...
        [{
         ...
         },
         {
             'source': [{
                 'outbound':
                 ['Beta_Cell', 'XRay_Tomography_Data_Anatomy_FKey']
             }, 'id'],
             'open':
             True,
             'markdown_name':
    ...
    'entry': [
        'RID', ['Beta_Cell', 'XRay_Tomography_Data_Dataset_FKey'],
        ['Beta_Cell', 'XRay_Tomography_Data_Biosample_FKey'],
        'Description', 'url',
...
key_defs = [
    em.Key.define(
        ...
        constraint_names=[('Beta_Cell',
                           'XRay_Tomography_Data_Dataset_RID_Key')],
    ...
    em.ForeignKey.define(
        ...
        annotations={
            ...
            'tag:isrd.isi.edu,2016:foreign-key': {
                ...
                'RID={{{$fkeys.Beta_Cell.XRay_Tomography_Data_Biosample_FKey.values._Dataset}}}'
            }
        },
        acls={
            'insert': ['*'],

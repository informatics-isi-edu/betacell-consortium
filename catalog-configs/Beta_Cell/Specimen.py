...
column_defs = [
    ...
    em.Column.define(
        'Cell_Line', em.builtin_types['text'], comment=column_comment['Cell_Line'],
    ),
    em.Column.define(
        'Protocol',
...
visible_columns = {
    ...
    'entry': [
        ...
        ['Beta_Cell', 'Specimen_Cellular_Location_Terms_FKey'], 'Description',
        'Collection_Date'
    ],
    '*': [
...
key_defs = [
    em.Key.define(['RID'], constraint_names=[('Beta_Cell', 'Specimen_RIDkey1')],
                  ),
]

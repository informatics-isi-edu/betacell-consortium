...
table_names = [
    'imaging_data', 'process', 'BellCellStatus', 'project', 'person', 'mesh_data', 'BellCellPlate',
    'project_publication', 'project_investigator', 'project_member',
]
...
schema_def = em.Schema.define('isa', comment=comment, acls=acls, annotations=annotations, )

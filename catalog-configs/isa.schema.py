...
table_names = [
    'project_investigator', 'process', 'imaging_data', 'BellCellStatus', 'project',
    'person', 'mesh_data', 'project_member', 'project_publication', 'BellCellPlate',
]
...
schema_def = em.Schema.define(
    'isa', comment=comment, acls=acls, annotations=annotations,
)

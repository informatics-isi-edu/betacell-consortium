...
visible_columns = {
    'filter': {
        'and': [{
            ...
            'Cell Line'
                ...
                {
                    'comment':
                    'Concentration of compound applied to cell line in mM',
                    'source': [{
                        'outbound': ['viz', 'model_biosample_fkey']
                    }, {
                        'outbound': ['Beta_Cell', 'biosample_specimen_fkey']
    ...
    'detailed':
    [['viz', 'model_dataset_fkey'], 'label', 'description', 'bg_color_r',
     'bg_color_g', 'bg_color_b', 'bounding_box_color_r',
     'bounding_box_color_g', 'bounding_box_color_b', 'show_bounding_box',
     'rotate', 'volume',
     {
         'source': [{
             'outbound': ['viz', 'model_biosample_fkey']
...
table_display = {
    'compact': {
        ...
        ':::iframe [{{{label}}}](/mesh-viewer/view.html?model=/ermrest/catalog/1/entity/viz:model_json/RID={{{_RID}}}){width=1024 height=768 .iframe} \n:::'
    }
}

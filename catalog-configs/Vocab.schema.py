...
table_names = [
    'anatomy_terms', 'cellular_location_terms', 'data_type_terms', 'cell_line_terms',
    'experiment_type_terms', 'file_type_terms', 'file_format_terms',
    'specimen_type_terms', 'species_terms',
]
...
schema_def = em.Schema.define(
    'vocab', comment=comment, acls=acls, annotations=annotations,
)
